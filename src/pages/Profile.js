...
class Profile extends Component {
	...
	render() {
		...
		return(
			...
			>
			  <Image style={{marginLeft:19}} source={require("../assets/Ellipse.png")} />
			  <Image style={{marginLeft:107}} source={require("../assets/Logo.png")} />
			  <Image style={{marginLeft:114,marginRight:25}} source={require("../assets/bell.png")} />
			</View>
			...
			<View style={{ flex: 3, borderColor: "#F2F2F2", borderBottomWidth: 1,marginLeft:35,marginRight:40 }}>
			  <ScrollView>
